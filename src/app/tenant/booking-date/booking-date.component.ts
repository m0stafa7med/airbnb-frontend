import {Component, CUSTOM_ELEMENTS_SCHEMA, effect, inject, input, OnDestroy, OnInit} from '@angular/core';
...
import {BookedDatesDTOFromClient, CreateBooking} from "../booking.model";
...
@Component({
  ...
  styleUrl: 'booking-date.component.scss'
})
